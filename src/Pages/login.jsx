    ...
    return (
        <div>
            <div className='bg-blue-800 h-screen flex text-center items-center justify-center'>
                <div>
                <h1 className=' mb-4 text-3xl text-white'>Log in</h1>
                    <div className='w-96 h-96 bg-neutral-200 rounded backdrop-blur-xs flex justify-center items-center'>
                        <form onSubmit={props.handleSubmitLogin} className='' >
                            ...
                            <br />
                            <input type='submit' value='Login' className='hover:cursor-pointer hover:bg-sky-600 w-36 h-10 bg-blue-800 text-zinc-100 mt-4' />
                            <div className='mt-4  '>
