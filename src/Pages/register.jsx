...
export default function Register(props) {
    ...
    return (
        <div>
            <div className='bg-blue-800 h-screen flex text-center items-center justify-center'>
                <div>
                    <h1 className=' mb-4 text-3xl text-white'>Register</h1>
                    <div className='w-96 h-96 bg-neutral-200 rounded backdrop-blur-xs flex justify-center items-center'>
                        <form onSubmit={props.handleSubmitRegister} className='' >
                            ...
                            <br />
                            <input type='submit' value='Register' className='hover:cursor-pointer hover:bg-sky-600 w-36 h-10 bg-blue-800 text-zinc-100 mt-4' />
                            <div className='mt-4  '>
